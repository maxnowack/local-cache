...
test('getInputAsArray throws error if required and missing', () => {
  expect(() =>
    actionUtils.getInputAsArray('foo', { required: true })).toThrowError()
})
...
test('getInputAsInt throws if required and value missing', () => {
  expect(() =>
    actionUtils.getInputAsInt('undefined', { required: true })).toThrowError()
})
...
test('getInputAsBool throws if required and value missing', () => {
  expect(() =>
    actionUtils.getInputAsBool('undefined2', { required: true })).toThrowError()
})
